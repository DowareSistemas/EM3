...
public class Operacoes_classe_imposto extends Entity
{
    ...
    @NotNull(message = "O CST/CSOSN é obrigatório")
    ...
    @NotNull(message = "Informe o tipo de PIS/COFINS")
    @NotEmpty(message = "Informe o tipo de PIS/COFINS")
    ...
    @Min(value = 1, message = "O tipo de movimento é obrigatório")
    ...
    @NotEmpty(message = "O código do CFOP é obrigatório")
    @NotNull(message = "O código do CFOP é obrigatório")
